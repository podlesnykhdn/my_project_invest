...
SBER_DEPOSIT_RATES = [
    ("2024-01-01", 10.0),   # базовая ~10%
    ("2024-05-27", 12.0),   # рост ключевой ставки
    ("2024-09-25", 16.0),   # ключевая 19%
    ("2024-10-28", 18.0),   # ключевая 21%
    ("2025-02-22", 17.0),   # снижение
    ("2025-06-09", 15.0),   # продолжение снижения
    ("2025-09-16", 13.5),   # ключевая 17%
    ("2025-12-25",  9.0),   # ключевая 16%
    ("2026-01-05",  8.0),   # Сбер снизил с 5 января
    ("2026-02-20",  7.5),   # Сбер снизил с 20 февраля
    ("2026-04-01",  7.0),   # Сбер снизил с 1 апреля
    ("2026-04-30",  6.5),   # Сбер снизил с 30 апреля — текущая
]
